...
def completar_tarefa(tarefa, indice_tarefa):
    indice_tarefa_ajutado = int(indice_tarefa) -1
    tarefa[indice_tarefa_ajutado]["completada"] = True
    print("Trafea {indice_tarefa} marcada como completada")
...
def deletar_tarefas_completadas(tarefas):
    ...
    print("Tarefas completadas forao deletadas")
    return

...
minha_lista = [1, 2, 3, 4, 5, "github", True, False]
...
print("Indice do elemento 6:", indice) # Mostra o indice do elemento "6"
...
# Método pop
elemento_removido = minha_lista.pop(6) #Remove um elemento atras do indice indicado
print("Elemento removido:", elemento_removido)
print("Após pop(7):", minha_lista)

# Método remove
minha_lista.remove(True) #Remove o elemento indicado
